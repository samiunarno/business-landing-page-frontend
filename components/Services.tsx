...
const servicesData = [
    { title: "START – Discover Your Path", description: "Understand who you are, what you want, and how to get there. The Aurevion AI Coaching guides you through reflective questions on WhatsApp, while your mentor (Rameen Noor) supports you in focused 1:1 Zoom sessions.", imageUrl: "https://picsum.photos/seed/webservice/800/600", svgPath: <><path d="M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path><path d="M12 3v18"></path><path d="M5 12h14"></path></> },
    { title: "GROW – Speak, Work, and Live with Confidence", description: "Master clear communication, professional self-presentation, and cultural understanding.The Aurevion AI Coaching analyses your expression, tone, and language use on WhatsApp; your mentor trains you 1:1 via Zoom using real corporate examples", imageUrl: "https://picsum.photos/seed/seoservice/800/600", svgPath: <><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></> },
    { title: "LIVE – Your Life. Your Future.", description: "Achieve real integration — professionally, socially, and emotionally.Together, we build structure, routine, and independence while the Aurevion AI Caoching supports you daily with reminders, exercises, and progress tracking.", imageUrl: "https://picsum.photos/seed/shopservice/800/600", svgPath: <><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"></path></> },
    { title: "Technology Meets Humanity", description: "•	AI on WhatsApp for reflection, exercises & instant feedback Personal sessions via Zoom or on-site App dashboard with visual analytics & certificates Real-life scenarios for practical learning Multilingual support (German / English)", imageUrl: "https://picsum.photos/seed/maintservice/800/600", svgPath: <><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"></path></> },
    { title: "INNOVATE – Global Entrepreneurship Mentoring", description: "To give you a clear and realistic framework for developing your idea — from the first spark to real implementation — without false promises or hype. This program doesn’t teach “six-figure hacks.” It helps you build the mindset, emotional resilience, and strategic clarity that every authentic entrepreneur needs.", imageUrl: "https://picsum.photos/seed/textservice/800/600", svgPath: <><path d="M17 3a2.828 2.828 0 114 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></> },
    { title: "TALENT & STUDY CONNECT — From Mentoring to Real-World Opportunity", description: "Designed for participants who have successfully completed their coaching or mentoring journey, this program provides targeted guidance for transitioning into their next academic or career phase — with strategic clarity, confident communication, and authentic presentation.", imageUrl: "https://picsum.photos/seed/logoservice/800/600", svgPath: <><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></> },
];
